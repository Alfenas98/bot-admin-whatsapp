...
const TEMPO_PREPARACAO_MS = 30 * 1000;
const TEMPO_PERGUNTA_MS = 30 * 1000;
...
async function iniciarJogo(sock, groupId, jogo, figurinhas) {
  ...
  await sock.sendMessage(groupId, {
    text: '⏳ A partir de agora só é permitido enviar figurinhas até o jogo acabar. O jogo começa em 30 segundos!'
  });
